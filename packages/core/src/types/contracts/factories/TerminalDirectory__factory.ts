...
export class TerminalDirectory__factory {
  static readonly abi = _abi;
  static createInterface(): TerminalDirectoryInterface {
    return new utils.Interface(_abi) as TerminalDirectoryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TerminalDirectory {
    return new Contract(address, _abi, signerOrProvider) as TerminalDirectory;
  }
}
